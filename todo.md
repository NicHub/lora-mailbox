...
- [ ] TX et RX : implémenter un système d'appairage permettant à un RX de lire uniquement les TX qui lui sont appairés
    - [ ] implémenter un système de chiffrement pour l'appairage et la confidentialité
